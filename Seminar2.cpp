...
void functie()
{
	...
	cout << "valoarea lui x prin addr_x: " << *addr_x << endl;
	cout << "valoarea lui x prin addr_addr_x: " << **addr_addr_x << endl;
	cout << "valoarea lui x prin addr_addr_addr_x: " << ***addr_addr_addr_x << endl;
